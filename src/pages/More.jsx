...
const ITEMS = [
  ...
  { to: "/Fires", icon: Flame, title: "Fire Center", desc: "VIIRS + EONET wildfire detections" },
  { to: "/Briefing", icon: Newspaper, title: "Weather briefing", desc: "Outlooks and local alerts" },
